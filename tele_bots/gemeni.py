...
bot = telebot.TeleBot("7395389291:AAFeVy7TlblhH27O7bBJSkb3Wlt63DRJKK4",parse_mode=None)

def generate():
    client = genai.Client(
        api_key=os.environ.get("AIzaSyDJGaHFtmxvZWoli3WlL5TPON3WLSDFdnk"),
    )
...
def echo_all(message):
    chat_sesion.send_message(message.text)
