    ...
    class Meta:
        ...
        widgets = {
            'name': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Enter your name for register'
            })
        }
...
class MessageEditForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'text': forms.TextInput(attrs={
                'class': 'form-control',
                'placeholder': 'Edit your Article','rows':3
            })
        }
class see_one(forms.ModelForm):
    class Meta:
        model = Message
        fields = ['text']
        widgets = {
...
class Message_H(forms.ModelForm):
    class Meta:
        model = Message
        fields = ['text']
        widgets = {
